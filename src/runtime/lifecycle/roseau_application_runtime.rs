...
pub struct RoseauApplicationRuntime {
    pub(crate) runtime: RoseauRuntime,
    pub(crate) game: Game,
    pub(crate) startup_runtime: RoseauStartupRuntime,
    pub(crate) startup_log_lines: Vec<String>,
    pub(crate) resolved_config_ip: Option<String>,
}
