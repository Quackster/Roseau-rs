...
#[test]
fn broadcasts_room_chat_to_room_socket_when_user_also_has_main_socket() {
    let mut manager = PlayerManager::new(vec![]);
    manager.insert(PlayerSession::new(60, 37120, details(7, "Alice")));
    let mut alice_room_session = PlayerSession::new(70, 37119, details(7, "Alice"));
    alice_room_session.set_room_user(room_user(7, "Alice"));
    manager.insert(alice_room_session);
    let mut bob_room_session = PlayerSession::new(80, 37119, details(8, "Bob"));
    bob_room_session.set_room_user(room_user(8, "Bob"));
    manager.insert(bob_room_session);
    ...
    let effects = RoomUserEffectNetworkPlan::plan(
        ...
        7,
        &[7, 8],
        &[room_user(7, "Alice"), room_user(8, "Bob")],
        &manager,
    );
