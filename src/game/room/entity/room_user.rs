...
pub struct RoomUser {
    ...
    pub(super) goal: Option<Position>,
    pub(super) next: Option<Position>,
    pub(super) statuses: HashMap<String, RoomUserStatus>,
    pub(super) path: VecDeque<Position>,
    pub(super) room_id: i32,
    pub(super) walking: bool,
    pub(super) needs_update: bool,
    pub(super) can_walk: bool,
    look_reset_time: i64,
    pub(super) current_item_id: Option<i32>,
    afk_timer: i32,
    afk_room_kick_ticks: i32,
    pub(super) kick_when_stop: bool,
}
